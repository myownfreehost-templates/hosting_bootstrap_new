...
<br><nav class="navbar fixed-bottom navbar-light bg-light opacity-75 rounded-top">
<div class="container">
<small><span class="badge rounded-pill bg-secondary"> &copy; <?php $year = date("Y"); echo $year; ?> <?echo $yourdomain;?></span></small>
